  ...
  return (
    <div className="mt-14 mx-auto">
      <div className="flex flex-col md:flex-row justify-between mb-8">
        <h3 className="h3 font-semibold">Analyticy ✨</h3>
        <div className="flex flex-col md:flex-row gap-x-3">
          <div className="bg-white border border-gray-200 py-[8px] px-2 min-w-64 rounded-md hover:border-gray-400 cursor-pointer mt-2  md:mt-0 flex">
            <MainDashCalendar />
          </div>
