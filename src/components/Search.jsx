...
const Search = () => {
  return (
    <div className="fixed z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white border dark:bg-[#42464D] p-4 rounded-md w-[370px] md:w-[550px] xl:w-[650px]">
